...
shf_data_max = shf_data - error
shf_data_min = shf_data + error
...
error_1 = error[np.where(type_1)]
shf_data_max_1 = shf_data_1 - error_1
shf_data_min_1 = shf_data_1 + error_1
...
error_2 = error[np.where(type_2)]
shf_data_max_2 = shf_data_2 - error_2
shf_data_min_2 = shf_data_2 + error_2
...
error_3 = error[np.where(type_3)]
shf_data_max_3 = shf_data_3 - error_3
shf_data_min_3 = shf_data_3 + error_3
...
error_4 = error[np.where(type_4)]
shf_data_max_4 = shf_data_4 - error_4
shf_data_min_4 = shf_data_4 + error_4
