            ...
            for uc_param in uc_params:
                ...
                if plot is True:
                    ...
                    eet_map(eet, colormap=eet_tassara_07,
                        ...
                        image='data/Te_Invertido/Imgs/Tassara_07.png')
                    eet_map(eet, colormap=eet_pg_07,
                        save_dir=save_dir_pg_07_400 + '', name=name,
                        image='data/Te_Invertido/Imgs/PG_07_400.png')
                    eet_map(eet, colormap=eet_pg_07,
                        save_dir=save_dir_pg_07_600 + '', name=name,
                        image='data/Te_Invertido/Imgs/PG_07_600.png')
                    eet_map(eet, colormap=eet_pg_07,
                        save_dir=save_dir_pg_07_800 + '', name=name,
                        image='data/Te_Invertido/Imgs/PG_07_800.png')
                mem()
    return eets, names
