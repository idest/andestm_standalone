...
#eet = np.loadtxt('Output/13_Termal/01_Mecanico/Exploration/Teq_vs_Tef/lc_uc/Archivos/Quartzite__Clpx-nita_W__Ol-dunite__Antigorite/Quartzite__Clpx-nita_W__Ol-dunite__Antigorite.txt')
